...
| [tRPC-Agent-Go](https://github.com/trpc-group/trpc-agent-go) | Supported | [Docs](https://trpc-group.github.io/trpc-agent-go/agui/), [Demos](https://dojo.ag-ui.com/trpc-agent-go/feature/shared_state) |
