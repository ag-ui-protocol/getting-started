...
| [Google ADK (JavaScript)](https://adk.dev/get-started/typescript/) | Supported | [Quickstart](/integrations/google-adk-js), [Demos](https://dojo.ag-ui.com/adk-js/feature/agentic_chat?openCopilot=true) |
