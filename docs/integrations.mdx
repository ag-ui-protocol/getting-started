...
- **[LangChain](https://www.langchain.com/langgraph)** - Balance agent control with agency
...
- **[Claude Agent SDK](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/claude-agent-sdk)** - Anthropic's local agent SDK, served over AG-UI
- **[Langroid](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/langroid)** - Lightweight Python framework for building multi-agent LLM applications
...
- **[CLI Agent Orchestrator](https://github.com/awslabs/cli-agent-orchestrator)** - Orchestrates real CLI coding-agent processes (Kiro CLI, Claude Code, Codex, and more) running in tmux terminals, normalizing a heterogeneous fleet into one AG-UI event vocabulary with shared state, handoff timeline, and interrupt-lifecycle approval for live provider permission prompts. See the [integration directory](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/cli-agent-orchestrator).
