...
- **[generative-a11y](https://generativea11y.com)** - Client-side accessibility runtime
  that translates public AG-UI lifecycle events into paced live-region announcements
  without replacing the host interface. See the [AG-UI guide](https://generativea11y.com/docs/integrations/ag-ui)
  and [npm package](https://www.npmjs.com/package/@generative-a11y/ag-ui).
