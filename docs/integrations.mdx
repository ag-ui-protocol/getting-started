...
- **[Google ADK](https://google.github.io/adk-docs/)** - Google's Agent Development Kit for building AI agents with Gemini models. AG-UI supports both the [Python middleware](https://github.com/ag-ui-protocol/ag-ui/tree/main/integrations/adk-middleware/python) and the [JavaScript runtime integration](/integrations/google-adk-js), with a [live ADK JavaScript demo](https://dojo.ag-ui.com/adk-js/feature/agentic_chat?openCopilot=true).
