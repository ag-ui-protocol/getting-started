...
export const protobufFixtures: ProtobufFixture[] = [
  ...
  // bytes for the three lifecycle events and for `subagentId` attribution;
  // before this, the TS encoder produced ZERO bytes for the lifecycle events and
  // silently dropped `subagentId` from everything else, so a stream that worked
  ...
  },
  {
    ...
    event: {
      ...
      messages: [
        ...
        { id: "s1", role: "assistant", content: "subagent speaking", subagentId: "sub-1" },
        { id: "s2", role: "tool", content: "done", toolCallId: "tc-1", subagentId: "sub-2" },
      ],
    } as unknown as BaseEvent,
  },
];
