...
from ._config import (
    DEFAULT_EMISSION_SHAPE as _DEFAULT_EMISSION_SHAPE,
    resolve_emission_shape as _resolve_emission_shape,
    resolve_emit_raw_events as _resolve_emit_raw_events,
)
from ._hitl import (
    HITLOptions,
...
async def _run_flow_event_stream(
    *,
    ...
    emission_shape: str = _DEFAULT_EMISSION_SHAPE,
):
...
def add_crewai_flow_fastapi_endpoint(
    ...
    *,
    ...
    resolved_emission_shape = _resolve_emission_shape(emission_shape)
